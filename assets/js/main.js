...
const loadEmbed = (type, target) => {
  ...
  if (type === 'bandsintown') {
    ...
    const artistName = payload.artistId || payload.artistName;
    target.innerHTML = `
      <a class="bit-widget-initializer"
         data-artist-name="${artistName}"
         data-events-to-display=""
         data-background-color="rgba(0,0,0,0)"
         data-separator-color="rgba(255,99,99,1)"
         ...
         data-sold-out-button-border-color="rgba(208,2,27,1)"
         ...
         data-event-rsvp-cta-text-color="rgba(208,2,27,1)"
         ...
         data-app-id="a8edf27028eb2ed38a51403a80531a44"
         data-affil-code=""
